...
import StoryTitle from '../../common/PageElement/StoryTitle';
import StoryText from '../../common/PageElement/StoryText';
import StoryImage from '../../common/PageElement/StoryImage';
import ListPart from '../../common/PageElement/ListPart';
import StroyVideo from '../../common/PageElement/StoryVideo';
        ...
        return (
            <div className="page-element">
                <div className="story">
                    ...
                    <StoryImage src="image/page-jacket-14.gif" title="다양한 색상의 Drone Jacket이 당신을 위해 준비되어 있습니다" />
