...
import StoryMultiImage from '../../PageElements/StoryMultiImage';

class StoryEn extends Component {
    render() {
        return (
            <div className="story">
                ...
                <StoryTitle text="DJI 드론 오너에게 꼭 필요한 필수 액세서리" />
                <StoryMultiImage elements={[
                    {src: "image/optimized/drone-jacket/page-jacket-6.png", alt: "Phantom 4 with Drone Jacket"},
                    {src: "image/optimized/drone-jacket/page-jacket-7.png", alt: "Mavic 2 with Drone Jacket"}
                ]} title="당신의 드론 이렇게 달라질 수 있습니다"/>
                <StoryText text="
                ...
                <StoryText text={"드론 재킷의 가장 큰 장점은 ¼\" 표준나사를 사용하여 측량용 센서, 360도 카메라나 조명기구, 소형 프로젝터등 다양한 액세서리를 결합시킬 수 있다는 점입니다.위의 영상과 같이 Phantom 4 드론에 360 카메라를 장착하여 멋진 파노라마 영상을 촬영하거나, 아래의 영상과 같이 드론 위에 스포트라이트를 장착하여 더 밝게 촬영할 수 있습니다."} />
                ...
                <StoryText text="다양한 색상의 드론 재킷이 준비되어 있어 당신이 원하는대로 드론의 색상을 변경시킬 수 있습니다." />
                ...
                <StoryImage src="image/optimized/drone-jacket/page-jacket-8.gif" />
                ...
                <StoryMultiImage elements={[
                    {src: "image/optimized/drone-jacket/page-jacket-10.png", alt: "Message on Phantom 4 Drone Jacket"},
                    {src: "image/optimized/drone-jacket/page-jacket-9.png", alt: "Message on Mavic 2 Drone Jacket"}
                ]} title="Jacket위에 자유로운 커스터마이징"/>
                <StoryText text="                                    
                        드론 재킷을 사용하면 드론 본체를 더럽히지 않고 자유롭게 스티커를 붙이거나 메시지를 새길 수 있습니다.
                        드론 재킷의 가장 큰 특징은 탈부착이 쉽고 드론에 손상을 주지 않는다는 점입니다.
                        서로 다른 색상의 드론 재킷에 원하는 대로 커스터마이징한 후 마음에 드는 대로 교체해서 사용하세요"
                />
            </div>
        );
    }
